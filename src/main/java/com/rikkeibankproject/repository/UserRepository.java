...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("SELECT new com.rikkeibankproject.dto.response.CustomerProjectionDTO(u.id, u.username, u.email, u.isKyc) FROM User u JOIN u.role r WHERE r.name = 'ROLE_CUSTOMER'")
